    ...
    UUPSUpgradeable
{
    ...
    function unstake(uint256 originalTokenId) external whenNotPaused {
        require(stakerOf[originalTokenId] == msg.sender, "Not your token");
        ...
        _removeFromArray(stakedTokens[msg.sender], originalTokenId);
        _removeFromArray(allStakedTokenIds, returnTokenId);
    ...
    function claim(address token) external nonReentrant whenNotPaused {
        require(allowedRewardTokens[token], "Token not allowed");
    ...
    function emergencyUnstake(uint256 tokenId, address to) external onlyOwner {
        ...
        _removeFromArray(allStakedTokenIds, tokenId);
