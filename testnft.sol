...
contract testjoints is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public publicCost = 6000 ether; // Public mint price
  uint256 public whitelistCost = 40000 ether; // Whitelist mint price
  uint256 public maxSupply = 4200;
  uint256 public maxMintAmount = 1000;
  uint256 public nftPerAddressLimit = 4200;
